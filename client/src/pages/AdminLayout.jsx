...
const AdminLayout = () => {
  ...
  // Fetch users from the database (replace with your actual API call)
  const fetchUsers = async () => {
    try {
      const response = await fetch("http://127.0.0.1:7000/admin"); // Replace with your API endpoint
              ...
              >
                <div className="flex gap-4 w-full  items-center justify-between">
                  <div className="flex gap-4  items-center justify-between">
                    <img
                      src={user.imageUrl} // Replace with the actual user profile picture URL
                      alt={user.username}
                      className="h-[3rem] aspect-video object-cover  rounded"
                    />
                    <div>
